#!/bin/bash
# =============================================================================
# 00_baseline - Layer Reuse Experiments - Smart Runner
# =============================================================================
...
#   bash experiments/00_baseline/sbatch/run.sh --dry-run
#   bash experiments/00_baseline/sbatch/run.sh
#   bash experiments/00_baseline/sbatch/run.sh --task mmlu --limit 10
#   bash experiments/00_baseline/sbatch/run.sh --config k1_first
#   bash experiments/00_baseline/sbatch/run.sh --force
#
...
EXAMPLES:
    ...
    bash experiments/${EXPERIMENT_NAME}/sbatch/run.sh --status --task mmlu
...
is_completed() {
    local config=$1
    # Check experiment-local artifacts directory
