...
# All tasks use --apply_chat_template --fewshot_as_multiturn to match original repo
declare -A TASK_CONFIGS=(
    ["mmlu"]="1|5|--fewshot_as_multiturn --apply_chat_template"
    ["gpqa_main_n_shot"]="1|0|--fewshot_as_multiturn --apply_chat_template"
    ["gsm8k"]="1|0|--fewshot_as_multiturn --apply_chat_template"
    ["minerva_math"]="1|0|--fewshot_as_multiturn --apply_chat_template"
    ["ifeval"]="1|0|--fewshot_as_multiturn --apply_chat_template"
)
